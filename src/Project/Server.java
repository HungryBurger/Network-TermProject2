...
public class Server extends JFrame implements ActionListener {
	...
	// jdbc set
	private String url = "jdbc:mysql://localhost:8000/network?serverTimezone=UTC&useSSL=false&useUnicode=true&characterEncoding=euc-kr";// user테이my블을 수정하면
	...
	String MyInformation(String user_id)
	{
		...
		return Rank_id+" "+Rank_pw+" "+Rank_name+" "+Rank_age+" "+Rank_score+" "+Rank_ranking+" "+Rank_victory+" "+Rank_lose;
	}
